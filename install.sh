...
echo "[3/7] Creating application directory: $APP_DIR"
mkdir -p "$APP_DIR"
mkdir -p "$APP_DIR/assets/css" "$APP_DIR/assets/js" "$APP_DIR/assets/html"

# ------------------- 5. Copy Files -------------------
echo "[4/7] Copying application files..."
cp "$INSTALL_DIR/sacn_relay_controller.py" "$APP_DIR/"
cp -r "$INSTALL_DIR/assets/"* "$APP_DIR/assets/"

# ------------------- 6. Setup Python Environment -------------------
echo "[5/7] Setting up Python virtual environment in $VENV_DIR..."
